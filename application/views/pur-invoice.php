      ...
      <div class="row invoice-info">
        <div class="col-sm-4 invoice-col">
          ...
          <address>
            ...
            <?= $this->lang->line('email'); ?>: <?php echo  $company_email; ?><br>
            <?= $this->lang->line('gst_number'); ?>: <?php echo  $company_gst_no; ?><br>
            <?= $this->lang->line('vat_number'); ?>: <?php echo  $company_vat_no; ?><br>
            <?= $this->lang->line('pan_number'); ?>: <?php echo  $company_pan_no; ?>

          </address>
        </div>
        <!-- /.col -->
        <div class="col-sm-4 invoice-col">
          <?= $this->lang->line('supplier_details'); ?><br>
          <address>
            ...
            ?>
            <br>
            <?= $this->lang->line('mobile'); ?>: <?php echo  $supplier_mobile; ?><br>
            <?= $this->lang->line('phone'); ?>: <?php echo  $supplier_phone; ?><br>
            <?= $this->lang->line('email'); ?>: <?php echo  $supplier_email; ?><br>
            <?= $this->lang->line('gst_number'); ?>: <?php echo  $supplier_gst_no; ?><br>
            <?= $this->lang->line('tax_number'); ?>: <?php echo  $supplier_tax_number; ?>
