      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <span id="company_name_msg" style="display:none" class="text-danger"></span>
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control no_special_char_no_space" id="mobile" name="mobile" placeholder="" value="<?php print $mobile; ?>" onkeyup="shift_cursor(event,'email')" maxlength="10">
          ...
          <span id="email_msg" style="display:none" class="text-danger"></span>
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control no_special_char_no_space" id="phone" name="phone" placeholder="" value="<?php print $phone; ?>" onkeyup="shift_cursor(event,'gstin')" maxlength="10">
