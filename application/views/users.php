      ...
      <div class="row">
        ...
        <div class="col-md-12">
            ...
            <form class="form-horizontal" id="category-form" onkeypress="return event.keyCode != 13;">
              ...
              <div class="box-body">
				<div class="form-group">
				  <label for="new_user" class="col-sm-2 control-label"><?= $this->lang->line('user_name'); ?><label class="text-danger">*</label></label>
                  <div class="col-sm-4">
          ...
          <label for="mobile" class="col-sm-2 control-label"><?= $this->lang->line('mobile'); ?><label class="text-danger">*</label></label>
                  <div class="col-sm-4">
                    <input type="text" class="form-control input-sm no_special_char_no_space"  id="mobile" name="mobile" placeholder="" value="<?php print $mobile; ?>" onkeyup="shift_cursor(event,'email')"  >
          ...
          <span id="email_msg" style="display:none" class="text-danger"></span>
                ...
                <div class="form-group">
                 <label for="role_id" class="col-sm-2 control-label"><?= $this->lang->line('role'); ?><label class="text-danger">*</label> </label>
                 <div class="col-sm-4">
                    <select class="form-control" <?=$disabled;?> id="role_id" name="role_id"  style="width: 100%;">
                       <?php
				...
				<div class="form-group">
				  <label for="pass" class="col-sm-2 control-label"><?= $this->lang->line('password'); ?><label class="text-danger">*</label></label>
                  <div class="col-sm-4">
