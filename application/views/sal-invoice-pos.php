			...
			<td>
				<table width="100%">
					...
					<tr>
						...
						<td><?= $this->lang->line('date'); ?> : <?= $sales_date." ".$created_time; ?></td>
					</tr>
				</table>
			...
			<td>
				...
				<table width="100%" cellpadding="0" cellspacing="0"  >
					...
					<tr style="border-top-style: dashed;border-bottom-style: dashed;border-width: 0.1px;">
						...
						<th style="font-size: 11px; text-align: right;padding-left: 2px; padding-right: 2px;"><?= $this->lang->line('quantity'); ?></th>
						<th style="font-size: 11px; text-align: right;padding-left: 2px; padding-right: 2px;"><?= $this->lang->line('price'); ?></th>
					...
					<tbody style="border-bottom-style: dashed;border-width: 0.1px;">
						<?php
			              ...
			              foreach ($q2->result() as $res2) {
			                  ...
			                  echo "<td style='text-align: right;padding-left: 2px; padding-right: 2px;'>".$res2->sales_qty."</td>";
					...
					<tfoot>
					 ...
					 <tr >
						<td style=" padding-left: 2px; padding-right: 2px;" colspan="4" align="right"><?= $this->lang->line('before_tax'); ?></td>
					...
					<tr>
						<td style=" padding-left: 2px; padding-right: 2px;" colspan="5"><br><i><?= $this->lang->line('inclusive_of_all_taxes'); ?></i></td>
					</tr>
					<tr>
