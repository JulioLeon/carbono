...
<table align="center" width="100%" height='100%'>
    <thead>
      ...
      <tr>
          <th colspan="5" rowspan="2" style="padding-left: 15px;">
            ...
            <?php echo $this->lang->line('email').": ".$company_email; ?><br/>
            <?php echo $this->lang->line('gst_number').": ".$company_gst_no; ?><br/>
            <?= $this->lang->line('vat_number');?>: <?php echo  $company_vat_no; ?>
    ...
    <?php echo $this->lang->line('name').": ".$supplier_name; ?><br/>
      <?php echo $this->lang->line('mobile').": ".$supplier_mobile; ?>
      <?php 
            ...
            ?>
            <br>
      <?php echo $this->lang->line('email').": ".$supplier_email; ?><br/>
