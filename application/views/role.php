      ...
      <div class="wrapper">
         ...
         <div class="content-wrapper">
            ...
            <section class="content-header">
               <h1>
                  <?=$page_title;?>
                  <small>Agregar/Actualizar Roles</small>
               </h1>
               <ol class="breadcrumb">
                                       ...
                                       <tr>
                                        ...
                                        <tr>
                                          ...
                                          <td>
                                              ...
                                              <div class="checkbox icheck"><label>
                                                <input type="checkbox" class="sales_all" id='sales_payment_view' name="permission[sales_payment_view]"> <?= $this->lang->line('payments_view'); ?>
                                              </label></div>
                                              <div class="checkbox icheck"><label>
                                                <input type="checkbox" class="sales_all" id='sales_payment_add' name="permission[sales_payment_add]"> <?= $this->lang->line('payments_add'); ?>
                                              </label></div>
                                              <div class="checkbox icheck"><label>
                                                <input type="checkbox" class="sales_all" id='sales_payment_delete' name="permission[sales_payment_delete]"> <?= $this->lang->line('payments_delete'); ?>
                                              </label></div>
                                          </td>
                                        </tr>
                                        <!-- SMS -->
