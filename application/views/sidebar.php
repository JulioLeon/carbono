...
<header class="main-header">
      ...
      <div class="navbar-custom-menu">
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="text-center" id="">
            <a title="POS" href="<?php echo $base_url; ?>pos"><i class="fa fa-calculator " ></i> POS </a>   
          </li>
          <?php } ?>
  ...
  <aside class="main-sidebar">
    ...
    <?php if($CI->permissions('sales_add')  || $CI->permissions('sales_view')) { ?>
		<li class="pos-active-li sales-list-active-li sales-active-li sales-return-active-li sales-returns-view-active-li treeview">
          <a href="#">
        ...
        <!-- <li class="sales-return-active-li"><a href="sales-return"><i class="fa fa-plus-square-o "></i> <span>Sales Return</span></a></li>
        <li class="sales-returns-view-active-li"><a href="sales-returns-view"><i class="fa fa-list "></i> <span>Sales Returns List</span></a></li> -->
          </ul>
        </li>
    <?php } ?>

		<!--<li class="header">CUSTOMERS</li>-->
    <?php if($CI->permissions('customers_add') || $CI->permissions('customers_view')) { ?>
    <li class="customers-view-active-li customers-active-li treeview">
          <a href="#">
    ...
    <?php if($CI->permissions('purchase_add') || $CI->permissions('purchase_view')) { ?>
		<li class="purchase-list-active-li purchase-active-li  treeview">
          <a href="#">
        ...
        <?php } ?>
        <?php if($CI->permissions('suppliers_add') || $CI->permissions('suppliers_view')) { ?>
        <li class="suppliers-list-active-li suppliers-active-li treeview">
          <a href="#">
        ...
        <li class="items-list-active-li items-active-li  category-view-active-li category-active-li brand-active-li brand-view-active-li labels-active-li treeview">
          <a href="#">
    ...
    <?php if($CI->permissions('sales_report') || $CI->permissions('item_sales_report') || $CI->permissions('purchase_report') || $CI->permissions('expense_report') || $CI->permissions('profit_report') || $CI->permissions('stock_report') || $CI->permissions('purchase_payments_report') || $CI->permissions('sales_payments_report') || $CI->permissions('expired_items_report')) { ?>
		<li class="report-sales-active-li report-purchase-active-li report-expense-active-li report-profit-loss-active-li report-stock-active-li report-purchase-payments-active-li report-sales-item-active-li report-sales-payments-active-li report-expired-items-active-li treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            ...
            <li class="report-profit-loss-active-li"><a href="<?php echo $base_url; ?>reports/profit_loss" ><i class="fa fa-files-o "></i> <span><?= $this->lang->line('profit_report'); ?></span></a></li>
            <?php } ?>
            <?php if($CI->permissions('stock_report')) { ?>
            <li class="report-stock-active-li"><a href="<?php echo $base_url; ?>reports/stock" ><i class="fa fa-files-o "></i> <span><?= $this->lang->line('stock_report'); ?></span></a></li>
            <?php } ?>
    ...
    <!-- SMS -->
     ...
     <li class="sms-active-li sms-api-active-li sms-template-active-li sms-templates-list-active-li treeview">
          <a href="#">
            <i class="fa fa-users text-aqua"></i> <span><?= $this->lang->line('sms'); ?></span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
    ...
    <?php if($change_password=true) { ?>
		<li class=" company-profile-active-li site-settings-active-li  change-pass-active-li dbbackup-active-li warehouse-active-li warehouse-list-active-li tax-active-li currency-view-active-li currency-active-li  database_updater-active-li tax-list-active-li units-list-active-li unit-active-li treeview">
          <a href="#">
