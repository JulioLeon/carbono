  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        ...
        <small>Agregar/Actualizar Usuario</small>
      </h1>
      <ol class="breadcrumb">
    ...
    <section class="content">
      <div class="row">
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header with-border">
              ...
              <div class="box-tools">
                ...
                <i class="fa fa-plus"></i> <?= $this->lang->line('new_user'); ?></a>
              </div>
            <?php }?>
            </div>
            <!-- /.box-header -->
          ...
          $qs1="select a.*,b.role_name from db_users a,db_roles b where b.id=a.role_id";
 ...
 /* dom:'<"row"<"col-sm-12"<"pull-left"B><"pull-right">>> <"row margin-bottom-12"<"col-sm-12"<"pull-left"l><"pull-right"fr>>>tip',*/
      buttons: {
        buttons: [
            ...
            { extend: 'copy', className: 'btn bg-teal color-palette btn-flat',text: 'Copiar',exportOptions: { columns: [0,1,2,3,4,5,6]} },
            ...
            { extend: 'print', className: 'btn bg-teal color-palette btn-flat',text:'Imprimir',exportOptions: { columns: [1,2,3,4,5,6]} },
