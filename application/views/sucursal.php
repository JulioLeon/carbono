        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header with-border">
              ...
              <!-- Aqui el primero -->
              <div class="box-tools">                
                <!-- <button data-toggle="modal"  data-toggle="modal" data-target="#modaladdsucursal" class="btn btn-warning"><i class="fa fa-plus "></i> Nuevo Almacén</button> -->
                <button type="button" class="btn btn-info " data-toggle="modal" data-target="#myModal"><i class="fa fa-plus "></i>Nueva Sucursal</button>
              </div>
...
<!-- Modal Actualizar -->
<div class="modal fade" id="updatesucursal" role="dialog">    
    <div class="modal-dialog">    
      <!-- Modal content-->
      <div class="modal-content">
        <div class="modal-header header-custom" style="position:relative;">          
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true" style="color:white;">×</span></button>
          <h4 class="modal-title text-center">Actualizar Sucursal</h4>          
        </div>
        <div class="modal-body">
          <!-- formulario -->
          <div class="row">
...
$(document).ready(function() {
  ...
  mostrar();
    ...
    $('#example33').DataTable({
     ...
     ajax: {
         url: "<?php echo base_url('Sucursal/ajax_list')?>",
         dataSrc: ''
     },dom: "Bfrtip",
     columns: [
...
<script src="<?php echo $theme_link; ?>js/sucursal.js"></script>
