...
<head>
  ...
  <!-- Tell the browser to be responsive to screen width s-->
  ...
  <div class="login-box-body">
    ...
    <form action="<?php echo $base_url; ?>login/verify" method="post">
      ...
      <div class="form-group has-feedback">
        <input type="text" class="form-control" placeholder="Usuario" id="username" name="username" autofocus><span class="glyphicon glyphicon-user form-control-feedback"></span>
      </div>
      <div class="form-group has-feedback">
    ...
    <a href="login/forgot_password">Olvidé mi contraseña </a><br>
    <div class="row">
