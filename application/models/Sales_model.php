...
class Sales_model extends CI_Model {
	...
	var $column_order = array( 'a.id','a.sales_date','a.sales_code','a.reference_no','a.grand_total','a.payment_status','a.created_by','b.customer_name','a.paid_amount','a.sales_status','a.pos'); //set column field database for datatable orderable
	var $column_search = array('a.id','a.sales_date','a.sales_code','a.reference_no','a.grand_total','a.payment_status','a.created_by','b.customer_name','a.paid_amount','a.sales_status','a.pos'); //set column field database for datatable searchable 
  ...
  public function verycorrelativo($corre)
  {
   ...
   //FIN DE CAMBIOS
	...
	function update_sales_payment_status($sales_id){
	//UPDATE PRODUCTS QUANTITY IN PRODUCTS TABLE
		...
		$q12 = $this->db->query("update db_customers set sales_due=(select COALESCE(SUM(grand_total),0)-COALESCE(SUM(paid_amount),0) from db_sales where customer_id='$customer_id') where id=$customer_id");
		if(!$q7)
		{
			return false;
		}
		      	...
		      	<div class="row invoice-info">
			        <div class="col-sm-4 invoice-col">
			          ...
			          <address>
			            ...
			            Mobile: <?php echo  $customer_mobile; ?><br>
			            Phone: <?php echo  $customer_phone; ?><br>
			            Email: <?php echo  $customer_email; ?><br>
			            GST Number: <?php echo  $customer_gst_no; ?><br>
			            Tax Number: <?php echo  $customer_tax_number; ?>
			          </address>
			        </div>
			        <!-- /.col -->
			        <div class="col-sm-4 invoice-col">
