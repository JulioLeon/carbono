...
class Site_model extends CI_Model {
	...
	public function update_site(){
        ...
        sales_discount='$sales_discount',change_return=$change_return,sales_invoice_format_id=$sales_invoice_format_id ,sales_invoice_footer_text='$sales_invoice_footer_text'
         $logo where id=$q_id";
        $query1= $this->db->simple_query($query1);
      
        $query2="update db_company set category_init='$category_init',item_init='$item_init',
        supplier_init='$supplier_init',purchase_init='$purchase_init',customer_init='$customer_init',sales_init='$sales_init',
